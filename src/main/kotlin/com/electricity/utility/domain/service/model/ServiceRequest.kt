package com.electricity.utility.domain.service.model
...
interface ServiceRequest {
    ...
    /**
     * Updates a service request with new status and message
     * @param requestId The ID of the request to update
     * @param message The update message
     * @param newStatus The new status of the request
     * @param updatedBy The ID or name of the user making the update
     * @return The created update if successful
     */
    fun updateRequest(requestId: String, message: String, newStatus: RequestStatus, updatedBy: String): RequestUpdate
}
